  ...
  return (
    <section className="relative px-4 pb-12 pt-12 sm:px-6 sm:pb-16 sm:pt-14 lg:px-8">
      <div className="mx-auto w-[min(1320px,94vw)]">
        <div className="relative overflow-hidden rounded-[1.75rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.07),rgba(255,255,255,0.02))] p-3 shadow-[0_24px_80px_rgba(0,0,0,0.34)] backdrop-blur-xl sm:rounded-[2.25rem] sm:p-5 lg:p-6">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.08),transparent_34%)]" />

          <div className="relative z-10 grid grid-cols-1 gap-4 sm:gap-5 lg:grid-cols-[1fr_0.9fr]">
            <MobileReveal variant="drift-left" y={28} blur={12} className="h-full">
            <div className="rounded-[1.5rem] border border-white/8 bg-black/35 p-5 sm:rounded-[2rem] sm:p-7 lg:p-8">
              ...
              >
                <div>
                  ...
                  <InputShell>
                    <input
                      ...
                      className="w-full bg-transparent px-4 py-4 text-sm text-white placeholder:text-white/30 focus:outline-none"
                    />
                  </InputShell>
                </div>
                  ...
                  <div className="grid gap-3 sm:grid-cols-3">
                    {formatOptions.map((option) => (
                      <button
                        ...
                        className={cn(
                          'rounded-[1.25rem] border px-4 py-4 text-left text-sm transition',
                ...
                <div className="pt-2">
                  <Button
                    type="submit"
                    className="h-12 w-full rounded-full bg-white px-7 text-black hover:bg-white/90"
                  >
                    Отправить
            ...
            <div className="relative h-full min-h-[320px] overflow-hidden rounded-[1.5rem] border border-[#ffb466]/20 bg-[linear-gradient(160deg,#ff9a32_0%,#ff7b11_46%,#d65300_100%)] p-2.5 sm:min-h-[420px] sm:rounded-[2rem] sm:p-5 lg:min-h-full">
              <Motion.div
                initial={{ opacity: 0, y: 28, scale: 0.98, filter: 'blur(10px)' }}
                whileInView={{ opacity: 1, y: 0, scale: 1, filter: 'blur(0px)' }}
                viewport={{ once: true, amount: 0.3 }}
                transition={{ duration: 0.8, ease: [0.22, 1, 0.36, 1] }}
                className="absolute inset-2.5 rounded-[1.35rem] bg-[radial-gradient(circle_at_26%_16%,rgba(255,255,255,0.24),transparent_34%),radial-gradient(circle_at_74%_26%,rgba(255,224,189,0.28),transparent_26%),radial-gradient(circle_at_50%_100%,rgba(118,39,0,0.22),transparent_52%),linear-gradient(180deg,rgba(255,255,255,0.08),rgba(0,0,0,0.08))] sm:inset-4 sm:rounded-[1.75rem]"
              />
              <div className="absolute inset-2.5 rounded-[1.35rem] border border-white/12 sm:inset-4 sm:rounded-[1.75rem]" />
              <div className="absolute -right-12 top-6 h-28 w-28 rounded-full bg-white/12 blur-3xl sm:-right-16 sm:top-10 sm:h-48 sm:w-48" />
              <div className="absolute -left-10 bottom-2 h-28 w-28 rounded-full bg-[#ffd0a4]/10 blur-3xl sm:hidden" />
              <div className="absolute inset-x-2.5 bottom-2.5 top-2.5 overflow-hidden rounded-[1.35rem] sm:inset-4 sm:rounded-[1.75rem]">
                ...
                <div className="absolute bottom-3 left-[42%] h-12 w-[70%] -translate-x-1/2 rounded-full bg-[radial-gradient(circle,rgba(92,28,0,0.34),transparent_72%)] blur-2xl sm:bottom-6 sm:left-1/2 sm:w-[56%]" />
                <Motion.img
                  ...
                  src={vladPhoto}
                  alt="Владислав"
                  className="absolute bottom-0 right-[-8%] z-10 h-[104%] w-auto max-w-none object-contain object-right-bottom drop-shadow-[0_24px_48px_rgba(0,0,0,0.28)] sm:right-1 sm:h-[95%] lg:right-[-2%] lg:h-[98%]"
                />
              </div>
            </div>
            </MobileReveal>
